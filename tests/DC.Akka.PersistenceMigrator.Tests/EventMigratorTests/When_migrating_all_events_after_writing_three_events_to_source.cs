...
public class When_migrating_all_current_events_after_writing_three_events_to_source(
    When_migrating_all_current_events_after_writing_three_events_to_source.Setup setup)
    : IClassFixture<When_migrating_all_current_events_after_writing_three_events_to_source.Setup>
{
    [Fact]
